...
*/
const personagens = document.querySelectorAll('.personagemjogadorselecionado')

personagens.forEach((personagemjogadorselecionado) => {
    personagemjogadorselecionado.addEventListener('mouseenter', () => {
